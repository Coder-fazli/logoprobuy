    ...
    <section className={cn('w-full overflow-hidden bg-background py-12 sm:py-24', className)}>
      <div className="container mx-auto grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-8">
        ...
        >
          ...
          />
          <motion.div
            className="absolute bottom-0 right-1/4 h-12 w-12 rounded-lg bg-purple-200/50"
            variants={floatingVariants}
            animate="animate"
          ...
          >
            <img src={images[0]} alt="Hero image 1" className="h-full w-full rounded-xl object-cover" />
          </motion.div>
          <motion.div
            ...
            variants={imageVariants}
          >
            <img src={images[1]} alt="Hero image 2" className="h-full w-full rounded-xl object-cover" />
          </motion.div>
          <motion.div
            ...
            variants={imageVariants}
          >
            <img src={images[2]} alt="Hero image 3" className="h-full w-full rounded-xl object-cover" />
          </motion.div>
        </motion.div>
      </div>
    </section>
